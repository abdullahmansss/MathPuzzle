...
public class Trophy_inter10 extends AppCompatActivity {
    ...
    Context context = Trophy_inter10.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter10);
        ...
        if (highScore < 10)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 10);
            editor.commit();
        }
