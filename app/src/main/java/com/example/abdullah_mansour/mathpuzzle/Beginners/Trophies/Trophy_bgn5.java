...
public class Trophy_bgn5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trophy_bgn5);
        ...
        Context context = Trophy_bgn5.this;
        ...
        releaseMediaPlayer();
        mp = MediaPlayer.create(Trophy_bgn5.this, R.raw.clapping);
        mp.start();
        ...
        contin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                releaseMediaPlayer();
                mp = MediaPlayer.create(Trophy_bgn5.this, R.raw.click);
                mp.start();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn5.this, Beginners.class);
                        startActivity(i);
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn5.this, MainActivity.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
