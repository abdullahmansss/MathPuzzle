...
public class Trophy_inter3 extends AppCompatActivity {
    ...
    Context context = Trophy_inter3.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter3);
        ...
        if (highScore < 3)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 3);
            editor.commit();
        }
