package com.example.abdullah_mansour.mathpuzzle.Intermediate;
...
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter1;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter10;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter11;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter12;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter13;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter14;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter15;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter16;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter17;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter18;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter19;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter2;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter20;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter3;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter4;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter5;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter6;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter7;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter8;
import com.example.abdullah_mansour.mathpuzzle.Intermediate.Quizzes.Quiz_inter9;
...
public class Intermediate extends AppCompatActivity {
    ...
    private Context context = Intermediate.this;
        ...
        stage1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter1.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter2.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter3.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter4.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter5.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter6.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter7.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter8.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter9.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter10.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter11.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter12.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage13.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter13.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage14.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter14.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter15.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter16.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage17.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter17.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage18.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter18.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage19.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter19.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        stage20.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(context, Quiz_inter20.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
