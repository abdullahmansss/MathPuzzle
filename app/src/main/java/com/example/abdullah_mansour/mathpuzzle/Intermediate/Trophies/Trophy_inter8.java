...
public class Trophy_inter8 extends AppCompatActivity {
    ...
    Context context = Trophy_inter8.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter8);
        ...
        if (highScore < 8)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 8);
            editor.commit();
        }
