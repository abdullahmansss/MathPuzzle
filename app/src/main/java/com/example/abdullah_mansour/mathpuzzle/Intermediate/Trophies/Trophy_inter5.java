...
public class Trophy_inter5 extends AppCompatActivity {
    ...
    Context context = Trophy_inter5.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter5);
        ...
        if (highScore < 5)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 5);
            editor.commit();
        }
