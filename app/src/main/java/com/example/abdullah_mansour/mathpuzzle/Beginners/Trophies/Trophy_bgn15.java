...
public class Trophy_bgn15 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn15.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn15);
        ...
        if (highScore < 15)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 15);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 15 in Math Quiz Game";
