...
public class Trophy_bgn1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trophy_bgn1);
        ...
        Context context = Trophy_bgn1.this;
        ...
        if (highScore < 1)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 1);
            editor.commit();
        }


        releaseMediaPlayer();
        mp = MediaPlayer.create(Trophy_bgn1.this, R.raw.clapping);
        mp.start();
        ...
        contin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                releaseMediaPlayer();
                mp = MediaPlayer.create(Trophy_bgn1.this, R.raw.click);
                mp.start();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn1.this, Beginners.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn1.this, MainActivity.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
