...
public class Trophy_bgn12 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn12.this;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn12);
        ...
        if (highScore < 12)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 12);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 12 in Math Quiz Game";
