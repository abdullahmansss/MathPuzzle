...
public class Trophy_inter17 extends AppCompatActivity {
    ...
    Context context = Trophy_inter17.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter17);
        ...
        if (highScore < 17)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 17);
            editor.commit();
        }
