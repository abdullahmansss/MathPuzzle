...
public class Trophy_inter20 extends AppCompatActivity {
    ...
    Context context = Trophy_inter20.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter20);
        ...
        if (highScore < 20)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 20);
            editor.commit();
        }
