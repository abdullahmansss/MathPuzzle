...
public class Trophy_bgn2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trophy_bgn2);
        ...
        Context context = Trophy_bgn2.this;
        ...
        if (highScore < 2)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 2);
            editor.commit();
        }

        releaseMediaPlayer();
        mp = MediaPlayer.create(Trophy_bgn2.this, R.raw.clapping);
        mp.start();
        ...
        contin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                releaseMediaPlayer();
                mp = MediaPlayer.create(Trophy_bgn2.this, R.raw.click);
                mp.start();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn2.this, Beginners.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn2.this, MainActivity.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
