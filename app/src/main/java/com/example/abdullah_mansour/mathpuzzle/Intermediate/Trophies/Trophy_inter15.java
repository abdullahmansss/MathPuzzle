...
public class Trophy_inter15 extends AppCompatActivity {
    ...
    Context context = Trophy_inter15.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter15);
        ...
        if (highScore < 15)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 15);
            editor.commit();
        }
