...
public class Trophy_bgn14 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn14.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn14);
        ...
        if (highScore < 14)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 14);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 14 in Math Quiz Game";
