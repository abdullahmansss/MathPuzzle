...
public class Trophy_inter19 extends AppCompatActivity {
    ...
    Context context = Trophy_inter19.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter19);
        ...
        if (highScore < 19)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 19);
            editor.commit();
        }
