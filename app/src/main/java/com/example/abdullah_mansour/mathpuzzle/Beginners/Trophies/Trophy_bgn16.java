...
public class Trophy_bgn16 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn16.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn16);
        ...
        if (highScore < 16)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 16);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 16 in Math Quiz Game";
