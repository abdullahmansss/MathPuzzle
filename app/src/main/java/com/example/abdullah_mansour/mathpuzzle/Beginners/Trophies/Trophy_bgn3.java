...
public class Trophy_bgn3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trophy_bgn3);
        ...
        Context context = Trophy_bgn3.this;
        ...
        releaseMediaPlayer();
        mp = MediaPlayer.create(Trophy_bgn3.this, R.raw.clapping);
        mp.start();
        ...
        contin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                releaseMediaPlayer();
                mp = MediaPlayer.create(Trophy_bgn3.this, R.raw.click);
                mp.start();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn3.this, Beginners.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn3.this, MainActivity.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 3 in Math Quiz Game";
