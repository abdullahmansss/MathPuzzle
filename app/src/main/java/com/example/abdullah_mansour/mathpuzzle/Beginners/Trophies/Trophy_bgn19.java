...
public class Trophy_bgn19 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn19.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn19);
        ...
        if (highScore < 19)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 19);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 19 in Math Quiz Game";
