package com.example.abdullah_mansour.mathpuzzle.Beginners.Trophies;
...
public class Trophy_bgn10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trophy_bgn10);
        ...
        Context context = Trophy_bgn10.this;
        ...
        if (highScore < 10)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 10);
            editor.commit();
        }

        releaseMediaPlayer();
        mp = MediaPlayer.create(Trophy_bgn10.this, R.raw.clapping);
        mp.start();
        ...
        contin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                releaseMediaPlayer();
                mp = MediaPlayer.create(Trophy_bgn10.this, R.raw.click);
                mp.start();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn10.this, Beginners.class);
                        startActivity(i);
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn10.this, MainActivity.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 10 in Math Quiz Game";
