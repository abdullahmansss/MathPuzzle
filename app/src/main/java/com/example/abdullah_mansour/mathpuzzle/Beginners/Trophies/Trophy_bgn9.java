...
public class Trophy_bgn9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trophy_bgn9);
        ...
        Context context = Trophy_bgn9.this;
        ...
        if (highScore < 9)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 9);
            editor.commit();
        }

        releaseMediaPlayer();
        mp = MediaPlayer.create(Trophy_bgn9.this, R.raw.clapping);
        mp.start();
        ...
        contin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View view) {
                releaseMediaPlayer();
                mp = MediaPlayer.create(Trophy_bgn9.this, R.raw.click);
                mp.start();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn9.this, Beginners.class);
                        startActivity(i);
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy_bgn9.this, MainActivity.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 9 in Math Quiz Game";
