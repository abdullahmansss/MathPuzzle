...
import com.example.abdullah_mansour.mathpuzzle.Beginners.Trophies.Trophy_bgn1;
import com.example.abdullah_mansour.mathpuzzle.MainActivity;
import com.example.abdullah_mansour.mathpuzzle.R;

public class Trophy_inter1 extends AppCompatActivity {
    ...
    Context context = Trophy_inter1.this;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter1);
        ...
        if (highScore < 1)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 1);
            editor.commit();
        }
