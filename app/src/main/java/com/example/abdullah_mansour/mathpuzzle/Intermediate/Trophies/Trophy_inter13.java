...
public class Trophy_inter13 extends AppCompatActivity {
    ...
    Context context = Trophy_inter13.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter13);
        ...
        if (highScore < 13)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 13);
            editor.commit();
        }
