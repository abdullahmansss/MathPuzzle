...
public class Trophy_inter4 extends AppCompatActivity {
    ...
    Context context = Trophy_inter4.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter4);
        ...
        if (highScore < 4)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 4);
            editor.commit();
        }
