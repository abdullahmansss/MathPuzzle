...
public class Trophy_inter2 extends AppCompatActivity {
    ...
    Context context = Trophy_inter2.this;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter2);
        ...
        if (highScore < 2)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 2);
            editor.commit();
        }
