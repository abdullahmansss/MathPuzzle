...
public class Trophy_inter11 extends AppCompatActivity {
    ...
    Context context = Trophy_inter11.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter11);
        ...
        if (highScore < 11)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 11);
            editor.commit();
        }
