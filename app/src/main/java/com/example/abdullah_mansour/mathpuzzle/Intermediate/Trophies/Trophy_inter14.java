...
public class Trophy_inter14 extends AppCompatActivity {
    ...
    Context context = Trophy_inter14.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter14);
        ...
        if (highScore < 14)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 14);
            editor.commit();
        }
