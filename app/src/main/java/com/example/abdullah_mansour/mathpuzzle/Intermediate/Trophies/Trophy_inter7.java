...
public class Trophy_inter7 extends AppCompatActivity {
    ...
    Context context = Trophy_inter7.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter7);
        ...
        if (highScore < 7)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 7);
            editor.commit();
        }
