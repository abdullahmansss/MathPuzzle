...
public class Trophy_bgn18 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn18.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn18);
        ...
        if (highScore < 18)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 18);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 18 in Math Quiz Game";
