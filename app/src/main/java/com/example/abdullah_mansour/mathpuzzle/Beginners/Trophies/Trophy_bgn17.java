...
public class Trophy_bgn17 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn17.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn17);
        ...
        if (highScore < 17)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 17);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 17 in Math Quiz Game";
