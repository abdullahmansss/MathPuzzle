...
public class Trophy_inter16 extends AppCompatActivity {
    ...
    Context context = Trophy_inter16.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter16);
        ...
        if (highScore < 16)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 16);
            editor.commit();
        }
