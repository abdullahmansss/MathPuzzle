...
public class Trophy_bgn13 extends AppCompatActivity {
    ...
    final Context context = Trophy_bgn13.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_bgn13);
        ...
        if (highScore < 13)
        {
            ...
            editor.putInt(getString(R.string.saved_high_score_key), 13);
            editor.commit();
        }
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sharebody = "I Completed Quiz 13 in Math Quiz Game";
