...
public class Trophy_inter9 extends AppCompatActivity {
    ...
    Context context = Trophy_inter9.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter9);
        ...
        if (highScore < 9)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 9);
            editor.commit();
        }
