...
public class Trophy4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        releaseMediaPlayer();
        mp = MediaPlayer.create(Trophy4.this, R.raw.clapping);
        mp.start();
        ...
        contin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                releaseMediaPlayer();
                mp = MediaPlayer.create(Trophy4.this, R.raw.click);
                mp.start();
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy4.this, Puzzles.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
        ...
        mainmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Trophy4.this, MainActivity.class);
                        startActivity(i);
                    }
                }, TIME_OUT);
            }
