...
public class Trophy_inter12 extends AppCompatActivity {
    ...
    Context context = Trophy_inter12.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter12);
        ...
        if (highScore < 12)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 12);
            editor.commit();
        }
