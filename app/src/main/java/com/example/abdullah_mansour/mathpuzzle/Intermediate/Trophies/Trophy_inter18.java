...
public class Trophy_inter18 extends AppCompatActivity {
    ...
    Context context = Trophy_inter18.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_trophy_inter18);
        ...
        if (highScore < 18)
        {
            ...
            editor.putInt(getString(R.string.intermediatehighscore), 18);
            editor.commit();
        }
